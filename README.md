...
Toutes les stratégies prédéfinies (Costume par numéro, Dominant Baccarat, Match nul, Pair/Impair VAR, Carte absente, Prédiction dans l’ombre) ont été supprimées.
Le bot ne conserve que le flux de prédictions IA : chaque stratégie créée par l’analyseur est enregistrée avec une explication détaillée (origine, observation, déclencheur, cible, preuve chiffrée, fiabilité, risques, mode d’emploi) visible dans la page « Stratégies IA ».
