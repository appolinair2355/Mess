...
function mine(rawGames = [], options = {}) {
  ...
  return {
    ...
    proposals: [
      ...day.proposals,
      // chaque proposition emporte sa règle machine : le panneau « Prédit »
      // peut alors la rejouer telle quelle, sans la redécouvrir.
      ...kept.map((k) => ({ ...k.proposal, rule: k.rule || null, rate: k.rate, support: k.support || 0 })),
    ],
